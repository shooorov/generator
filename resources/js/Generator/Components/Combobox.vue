<template>
    <Combobox as="div" v-model="selectedItem">
        ...
        <div class="relative w-full">
            <ComboboxInput :class="[disabled ? 'bg-gray-100' : '', 'w-full rounded border border-gray-300 bg-white py-2 pl-3 pr-10 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 sm:text-sm']" @change="query = $event.target.value" :displayValue="(item) => item.name" Placeholder="Select" autocomplete="off" :disabled="disabled"/>
