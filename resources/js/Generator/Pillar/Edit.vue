            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow sm:rounded-lg">
                    <div class="flex justify-between px-4 py-5 border-b border-gray-200 sm:px-6">
                        <p class="max-w-2xl leading-10 text-gray-700 text-lg font-medium"> Pillar Edit</p>
...
export default {
    ...
    setup (props) {
        ...
        const form = reactive({
            ...
            pillar_type_id: props.pillar.pillar_type_id,
        })

        function submit() {
            router.patch(route('generator.pillar.update', props.pillar.id), form)
        }
