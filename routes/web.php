...
Route::prefix('generator')->name('generator.')->group(function () {
    ...
    Route::name('desk.')->prefix('desks')->group(function () {
        ...
        Route::post('/{desk}/update', [DeskController::class, 'update'])->name('update'); // generator.desk.update
        ...
        Route::post('/{desk}/decoration', [DeskController::class, 'decoration'])->name('decoration'); // generator.desk.decoration
    ...
    Route::name('pillar.')->prefix('pillars')->group(function () {
        ...
        Route::post('/{pillar}/update', [PillarController::class, 'update'])->name('update'); // generator.pillar.update
    ...
    Route::name('pillar_type.')->prefix('pillar-types')->group(function () {
        ...
        Route::post('/{pillar_type}/update', [PillarTypeController::class, 'update'])->name('update'); // generator.pillar_type.update
